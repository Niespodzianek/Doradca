...
def notowania_obserwowanych_spolki(lista_akcji_z):
    ...
    for spolka in lista_innych_spolek:
        ...
        przeszukanie_pojedynczej_spolki_ze_strony_www(analizowany_tekst=tekst_ze_strony)

def przeszukanie_pojedynczej_spolki_ze_strony_www(analizowany_tekst):
    tekst_strony_www = analizowany_tekst
    lista_akcji = []
    marker_start = 0
    marker_poczatku_szukania = tekst_strony_www.index("profile-h1-c", marker_start)
    marker_poczatku_wycinania = tekst_strony_www.index('<h1>', marker_poczatku_szukania) + len('<h1>')
    marker_konca_wycinania = tekst_strony_www.index("</h1>", marker_poczatku_wycinania)
    ...
    for _ in lista_akcji:
        print(f"{spolka} - aktualny kurs: {kurs}, otwarcie: {otwarcie}, maksymalny: {maksimum},"
